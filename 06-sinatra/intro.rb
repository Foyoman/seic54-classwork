...
get '/fanclub/:first/:last' do
    "#{params[:first].capitalize} #{params[:last].capitalize} is a silver member of the Marx Brothers Fan Club"
end

# $1000 gold membership: /fanclub/pope/boniface/harpo
get '/fanclub/:first/:last/:favorite' do
    "#{params[:first].capitalize} #{params[:last].capitalize} is a gold member of the Marx Brothers Fan Club and their favorite brother is #{params[:favorite].capitalize}"
end
